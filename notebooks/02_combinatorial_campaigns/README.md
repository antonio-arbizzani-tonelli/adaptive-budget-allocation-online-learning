# Scaling Budgeted Learning to Multiple Campaigns
...
On the same environment realizations, final pseudo-regret falls from about 595 to about 72 and the learner reaches about 96% of the benchmark's expected reward. Expenditure follows the budget through the end of the horizon without violating it. In the ablations, empirical cost reduces pseudo-regret from about 165 to 72 relative to the cost LCB, while the KL bound reduces it from about 101 to 72 relative to Hoeffding.
